...
namespace PotteryHaptics.Experiment
{
    ...
    /// 映像条件は常にRich(Minimal/Rich比較は廃止済み)。
    /// </summary>
    public class TrialSequencerJND : MonoBehaviour
    {
        ...
        [SerializeField] private int trialsPerLevel = 16;
        ...
        private IEnumerator RunSession()
        {
            ...
            {
                yield return RunSingleTrial(trial);
            }
        ...
        private IEnumerator RunSingleTrial(PlannedTrial trial)
        {
